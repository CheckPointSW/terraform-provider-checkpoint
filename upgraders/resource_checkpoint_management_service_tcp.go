...
// ResourceManagementServiceTcpV0 is the V0 schema where aggressive_aging was TypeMap.
func ResourceManagementServiceTcpV0() *schema.Resource {
...
// ResourceManagementServiceTcpStateUpgradeV0 converts aggressive_aging from TypeMap to TypeList.
func ResourceManagementServiceTcpStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {

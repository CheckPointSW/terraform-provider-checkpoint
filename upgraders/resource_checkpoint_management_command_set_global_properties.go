...
// ResourceManagementCommandSetGlobalPropertiesV0 is the V0 schema where many top-level fields were TypeMap.
func ResourceManagementCommandSetGlobalPropertiesV0() *schema.Resource {
...
// ResourceManagementCommandSetGlobalPropertiesStateUpgradeV0 converts the TypeMap fields to TypeList.
func ResourceManagementCommandSetGlobalPropertiesStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {
	return UpgradeMapsToLists(rawState,
		"firewall", "nat", "authentication", "vpn", "remote_access",
		"user_directory", "qos", "carrier_security", "user_accounts", "user_authority",
		"connect_control", "stateful_inspection", "log_and_alert", "data_access_control",
		"proxy", "user_check", "hit_count", "advanced_conf",
	), nil
}

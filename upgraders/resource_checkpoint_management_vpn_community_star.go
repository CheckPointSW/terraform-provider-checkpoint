...
// ResourceManagementVpnCommunityStarV0 is the V0 schema where ike_phase_1, ike_phase_2,
// and granular_encryptions[*].ike_phase_1/2 were TypeMap.
func ResourceManagementVpnCommunityStarV0() *schema.Resource {
...
// ResourceManagementVpnCommunityStarStateUpgradeV0 converts ike_phase_1/2 from TypeMap to TypeList.
func ResourceManagementVpnCommunityStarStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {

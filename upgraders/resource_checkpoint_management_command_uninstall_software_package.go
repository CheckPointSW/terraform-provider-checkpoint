...
// ResourceManagementCommandUninstallSoftwarePackageV0 is the V0 schema where cluster_installation_settings was TypeMap.
func ResourceManagementCommandUninstallSoftwarePackageV0() *schema.Resource {
...
// ResourceManagementCommandUninstallSoftwarePackageStateUpgradeV0 converts cluster_installation_settings from TypeMap to TypeList.
func ResourceManagementCommandUninstallSoftwarePackageStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {

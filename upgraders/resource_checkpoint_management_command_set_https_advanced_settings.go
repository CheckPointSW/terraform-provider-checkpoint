...
// ResourceManagementCommandSetHttpsAdvancedSettingsV0 is the V0 schema where bypass_under_load and
// server_certificate_validation_actions were TypeMap.
func ResourceManagementCommandSetHttpsAdvancedSettingsV0() *schema.Resource {
...
// ResourceManagementCommandSetHttpsAdvancedSettingsStateUpgradeV0 converts the TypeMap fields to TypeList.
func ResourceManagementCommandSetHttpsAdvancedSettingsStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {
	return UpgradeMapsToLists(rawState, "bypass_under_load", "server_certificate_validation_actions"), nil
}

...
// ResourceManagementSimpleClusterV0 is the V0 schema where several top-level fields and
// fields within interfaces were TypeMap instead of TypeList.
func ResourceManagementSimpleClusterV0() *schema.Resource {
...
// ResourceManagementSimpleClusterStateUpgradeV0 converts TypeMap fields to TypeList and upgrades
...
func ResourceManagementSimpleClusterStateUpgradeV0(_ context.Context, rawState map[string]interface{}, _ interface{}) (map[string]interface{}, error) {
	return UpgradeMapsToLists(rawState, "nat_settings", "proxy_settings", "firewall_settings", "vpn_settings", "interfaces"), nil
}

...
func dataGaiaShowGreInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowGreInterfaces,
...
func readGaiaShowGreInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "gre-interfaces",        // resource type
            "read",                       // operation
            "show-gre-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-gre-interfaces: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-gre-interfaces-" + acctest.RandString(10)))
    return nil
}

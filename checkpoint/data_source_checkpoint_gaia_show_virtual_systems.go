...
func dataGaiaShowVirtualSystems() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowVirtualSystems,
        Schema: map[string]*schema.Schema{
            ...
            "order": {
                ...
                Optional:    true,
                Description: `Sorts the virtual systems by either ascending or descending order.`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func readGaiaShowVirtualSystems(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "virtual-systems",        // resource type
            "read",                       // operation
            "show-virtual-systems",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-virtual-systems: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-virtual-systems-" + acctest.RandString(10)))
    return nil
}

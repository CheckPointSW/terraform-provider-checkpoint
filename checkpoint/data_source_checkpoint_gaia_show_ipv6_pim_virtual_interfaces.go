...
func dataGaiaShowIpv6PimVirtualInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIpv6PimVirtualInterfaces,
...
func readGaiaShowIpv6PimVirtualInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ipv6-pim-virtual-interfaces",        // resource type
            "read",                       // operation
            "show-ipv6-pim-virtual-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ipv6-pim-virtual-interfaces: %v", err)
    }
            ...
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "vifid": func() int { if f, ok := m["vifid"].(float64); ok { return int(f) }; return 0 }(),
    ...
    d.SetId(fmt.Sprintf("show-ipv6-pim-virtual-interfaces-" + acctest.RandString(10)))
    return nil
}

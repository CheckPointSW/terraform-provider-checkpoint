...
func dataGaiaShowMldSummary() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowMldSummary,
...
func readGaiaShowMldSummary(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "mld-summary",        // resource type
            "read",                       // operation
            "show-mld-summary",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-mld-summary: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-mld-summary-" + acctest.RandString(10)))
    return nil
}

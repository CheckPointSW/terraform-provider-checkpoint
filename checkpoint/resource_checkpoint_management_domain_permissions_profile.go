...
func createManagementDomainPermissionsProfile(d *schema.ResourceData, m interface{}) error {
	...
	addDomainPermissionsProfileRes, err := client.ApiCall("add-domain-permissions-profile", domainPermissionsProfile, client.GetSessionID(), true, false)
...
func readManagementDomainPermissionsProfile(d *schema.ResourceData, m interface{}) error {
	...
	showDomainPermissionsProfileRes, err := client.ApiCall("show-domain-permissions-profile", payload, client.GetSessionID(), true, false)
	if err != nil {
		return fmt.Errorf(err.Error())
	}
...
func updateManagementDomainPermissionsProfile(d *schema.ResourceData, m interface{}) error {
	...
	updateDomainPermissionsProfileRes, err := client.ApiCall("set-domain-permissions-profile", domainPermissionsProfile, client.GetSessionID(), true, false)
...
func deleteManagementDomainPermissionsProfile(d *schema.ResourceData, m interface{}) error {
	...
	deleteDomainPermissionsProfileRes, err := client.ApiCall("delete-domain-permissions-profile", domainPermissionsProfilePayload, client.GetSessionID(), true, false)

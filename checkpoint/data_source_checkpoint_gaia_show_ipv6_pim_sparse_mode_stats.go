...
func dataGaiaShowIpv6PimSparseModeStats() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIpv6PimSparseModeStats,
...
func readGaiaShowIpv6PimSparseModeStats(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ipv6-pim-sparse-mode-stats",        // resource type
            "read",                       // operation
            "show-ipv6-pim-sparse-mode-stats",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ipv6-pim-sparse-mode-stats: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-ipv6-pim-sparse-mode-stats-" + acctest.RandString(10)))
    return nil
}

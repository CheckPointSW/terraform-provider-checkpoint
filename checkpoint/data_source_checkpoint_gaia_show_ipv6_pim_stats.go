...
func dataGaiaShowIpv6PimStats() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIpv6PimStats,
...
func readGaiaShowIpv6PimStats(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ipv6-pim-stats",        // resource type
            "read",                       // operation
            "show-ipv6-pim-stats",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ipv6-pim-stats: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-ipv6-pim-stats-" + acctest.RandString(10)))
    return nil
}

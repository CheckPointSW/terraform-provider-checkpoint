...
func dataGaiaShowRoutesStatic() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowRoutesStatic,
...
func readGaiaShowRoutesStatic(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "routes-static",        // resource type
            "read",                       // operation
            "show-routes-static",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-routes-static: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-routes-static-" + acctest.RandString(10)))
    return nil
}

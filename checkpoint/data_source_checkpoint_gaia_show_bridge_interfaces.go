...
func dataGaiaShowBridgeInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowBridgeInterfaces,
...
func readGaiaShowBridgeInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "bridge-interfaces",        // resource type
            "read",                       // operation
            "show-bridge-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-bridge-interfaces: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-bridge-interfaces-" + acctest.RandString(10)))
    return nil
}

...
func createManagementIdpAdministratorGroup(d *schema.ResourceData, m interface{}) error {
	...
	addIdpAdministratorGroupRes, err := client.ApiCall("add-idp-administrator-group", idpAdministratorGroup, client.GetSessionID(), true, false)
...
func updateManagementIdpAdministratorGroup(d *schema.ResourceData, m interface{}) error {
	...
	updateIdpAdministratorGroupRes, err := client.ApiCall("set-idp-administrator-group", idpAdministratorGroup, client.GetSessionID(), true, false)
...
func deleteManagementIdpAdministratorGroup(d *schema.ResourceData, m interface{}) error {
	...
	deleteIdpAdministratorGroupRes, err := client.ApiCall("delete-idp-administrator-group", idpAdministratorGroupPayload, client.GetSessionID(), true, false)

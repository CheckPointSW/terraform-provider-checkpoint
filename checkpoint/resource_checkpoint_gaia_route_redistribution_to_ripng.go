...
func resourceGaiaRouteRedistributionToRipng() *schema.Resource {   
    return &schema.Resource{
        Create: createGaiaRouteRedistributionToRipng,
        Read:   readGaiaRouteRedistributionToRipng,
        Update: updateGaiaRouteRedistributionToRipng,
        Delete: deleteGaiaRouteRedistributionToRipng,
        Schema: map[string]*schema.Schema{
            ...
            "from": {
                ...
                Optional:    true,
                Description: `Configure policy for exporting routes to RIPng`,
                MaxItems:    1,
                Elem: &schema.Resource{
                    Schema: map[string]*schema.Schema{
                        "aggregate": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Specifies the aggregate route to redistribute into RIPng`,
                            MaxItems:    1,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "all_ipv6_routes": {
                                        ...
                                        Elem: &schema.Resource{
                                            Schema: map[string]*schema.Schema{
                                                "metric": {
                                                    ...
                                                    Optional:    true,
                                                    Description: `Specifies RIPng metric value to routes matching this rule`,
                                                },
                                                "enable": {
                                                    Type:        schema.TypeBool,
                                                    Optional:    true,
                        ...
                        "nat_pool": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Redistribution of NAT pools into RIPng`,
                            MaxItems:    1,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "all_ipv6_routes": {
                        ...
                        "static_route": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Redistribution of static routes into RIPng`,
                            MaxItems:    1,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "all_ipv6_routes": {
                                    ...
                                    "default6": {
                                        Type:        schema.TypeList,
                                        Optional:    true,
                                        Description: `Applies this configuration to all routes from the given protocol described by an IPv6 network, unless a more specific route redistribution rule applies`,
                                        MaxItems:    1,
                                        Elem: &schema.Resource{
                                            Schema: map[string]*schema.Schema{
                                                "metric": {
                        ...
                        "bgp_as_number": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures Autonomous System numbers of the BGP group from which to export routes into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "as_number": {
                                        Type:        schema.TypeString,
                        ...
                        "bgp_as_path": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures the redistribution of BGP routes, whose AS path matches a given regular expression into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "aspath_regex": {
                                        Type:        schema.TypeString,
                        ...
                        "interface": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures the redistribution of all directly connected routes from an interface into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "interface": {
                                        Type:        schema.TypeString,
                                    ...
                                    "metric": {
                                        Type:        schema.TypeString,
                                        Optional:    true,
                                        Description: `Specifies the BGP metric to be added to routes redistributed via this rule<br><br>The metric used by RIP/RIPng is a hop count, representing the distance to a destination. Routes with higher hop counts are more expensive. Routes with a metric greater than or equal to 16 are treated as unreachable, and are not installed or propagated to peers`,
                                    },
                                },
                            },
                        },
                        "isis": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures the redistribution of IS-IS routes into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "level": {
                                        Type:        schema.TypeString,
                        ...
                        "ospf3": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures the redistribution of IPv6 OSPF routes into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "instance": {
                                        Type:        schema.TypeString,
                        ...
                        "ospf3ase": {
                            Type:        schema.TypeList,
                            Optional:    true,
                            Description: `Configures the redistribution of IPv6 OSPF Autonomous System External routes into RIPng`,
                            Elem: &schema.Resource{
                                Schema: map[string]*schema.Schema{
                                    "instance": {
                                        Type:        schema.TypeString,
            ...
            "reset": {
                Type:        schema.TypeBool,
                Optional:    true,
                Description: `Removes RIPng Route Redistribution configuration`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func createGaiaRouteRedistributionToRipng(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        success := err == nil && addRouteRedistributionToRipngRes.Success
        errMsg := ""
        if err != nil {
            errMsg = err.Error()
        } else if !addRouteRedistributionToRipngRes.Success {
            errMsg = addRouteRedistributionToRipngRes.ErrorMsg
        }

        var respData map[string]interface{}
        if err == nil {
            respData = addRouteRedistributionToRipngRes.GetData()
        }

        debugLogOperation(
            "route-redistribution-to-ripng",        // resource type
            "create",                       // operation
            "set-route-redistribution-to-ripng",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to add route-redistribution-to-ripng: %v", err)
    }
    if !addRouteRedistributionToRipngRes.Success {
        if addRouteRedistributionToRipngRes.ErrorMsg != "" {
            return fmt.Errorf(addRouteRedistributionToRipngRes.ErrorMsg)
        }
        return fmt.Errorf("Unknown error occurred")
    }

    d.SetId(fmt.Sprintf("route-redistribution-to-ripng-" + acctest.RandString(10)))
    return readGaiaRouteRedistributionToRipng(d, m)
}

func readGaiaRouteRedistributionToRipng(d *schema.ResourceData, m interface{}) error {
    ...
    showRouteRedistributionToRipngRes, err := client.ApiCallSimple("show-route-redistribution-to-ripng", payload)
    // DEBUG: generic logger
    if resourceDebugEnabled(d) {
        success := err == nil && showRouteRedistributionToRipngRes.Success
        errMsg := ""
        if err != nil {
            errMsg = err.Error()
        } else if !showRouteRedistributionToRipngRes.Success {
            errMsg = showRouteRedistributionToRipngRes.ErrorMsg
        }

        var respData map[string]interface{}
        if err == nil {
            respData = showRouteRedistributionToRipngRes.GetData()
        }

        debugLogOperation(
            "route-redistribution-to-ripng",        // resource type
            "read",                       // operation
            "show-route-redistribution-to-ripng",         // API call name
            payload,                        // request payload
            respData,                       // response data (if any)
            success,
            errMsg,
    ...
    if err != nil {
        return fmt.Errorf("Failed to show route-redistribution-to-ripng: %v", err)
    }
    if !showRouteRedistributionToRipngRes.Success {
        if data := showRouteRedistributionToRipngRes.GetData(); data != nil {
        ...
        return fmt.Errorf(showRouteRedistributionToRipngRes.ErrorMsg)
    }
    ...
    if v, exists := routeRedistributionToRipng["ripng"]; exists {
        ...
        if ripngItems, ok := v.([]interface{}); ok && len(ripngItems) > 0 {
            apiItem, _ := ripngItems[0].(map[string]interface{})
    ...
    if v, exists := routeRedistributionToRipng["member-id"]; exists {
...
func updateGaiaRouteRedistributionToRipng(d *schema.ResourceData, m interface{}) error {
    ...
    setRouteRedistributionToRipngRes, err := client.ApiCallSimple("set-route-redistribution-to-ripng", payload)
    // DEBUG: generic logger
    if resourceDebugEnabled(d) {
        success := err == nil && setRouteRedistributionToRipngRes.Success
        errMsg := ""
        if err != nil {
            errMsg = err.Error()
        } else if !setRouteRedistributionToRipngRes.Success {
            errMsg = setRouteRedistributionToRipngRes.ErrorMsg
        }

        var respData map[string]interface{}
        if err == nil {
            respData = setRouteRedistributionToRipngRes.GetData()
        }
    ...
    if err != nil {
        return fmt.Errorf("Failed to set route-redistribution-to-ripng: %v", err)
    }
    if !setRouteRedistributionToRipngRes.Success {
        return fmt.Errorf(setRouteRedistributionToRipngRes.ErrorMsg)
    }

    return readGaiaRouteRedistributionToRipng(d, m)
}

func deleteGaiaRouteRedistributionToRipng(d *schema.ResourceData, m interface{}) error {

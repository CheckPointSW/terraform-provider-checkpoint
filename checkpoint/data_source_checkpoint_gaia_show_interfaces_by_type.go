...
func dataGaiaShowInterfacesByType() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowInterfacesByType,
...
func readGaiaShowInterfacesByType(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "interfaces-by-type",        // resource type
            "read",                       // operation
            "show-interfaces-by-type",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-interfaces-by-type: %v", err)
    }
    if !commandRes.Success {
        return fmt.Errorf(commandRes.ErrorMsg)
    }

    if v, exists := commandRes.GetData()["physical-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            ...
            d.Set("physical_interfaces", mapped)
        }
    } else {
        d.Set("physical_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["loopback-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("loopback_interfaces", mapped)
        }
    } else {
        d.Set("loopback_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["bridge-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("bridge_interfaces", mapped)
        }
    } else {
        d.Set("bridge_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["bond-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("bond_interfaces", mapped)
        }
    } else {
        d.Set("bond_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["alias-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("alias_interfaces", mapped)
        }
    } else {
        d.Set("alias_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["vlan-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("vlan_interfaces", mapped)
        }
    } else {
        d.Set("vlan_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["vxlan-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
            ...
            d.Set("vxlan_interfaces", mapped)
        }
    } else {
        d.Set("vxlan_interfaces", []interface{}{})
    }
    if v, exists := commandRes.GetData()["gre-interfaces"]; exists {
        if raw, ok := v.([]interface{}); ok {
            mapped := make([]interface{}, len(raw))
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "rx_bytes": func() int { if f, ok := m["rx-bytes"].(float64); ok { return int(f) }; return 0 }(),
                        "rx_packets": func() int { if f, ok := m["rx-packets"].(float64); ok { return int(f) }; return 0 }(),
                        "gre_id": func() int { if f, ok := m["gre-id"].(float64); ok { return int(f) }; return 0 }(),
                        "local_ip_address": func() string { if _v, _ok := m["local-ip-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "remote_ip_address": func() string { if _v, _ok := m["remote-ip-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "ttl": func() int { if f, ok := m["ttl"].(float64); ok { return int(f) }; return 0 }(),
                        "ipv4_address": func() string { if _v, _ok := m["ipv4-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "peer_address": func() string { if _v, _ok := m["peer-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "enabled": func() bool { if b, ok := m["enabled"].(bool); ok { return b }; if s, ok := m["enabled"].(string); ok { return s == "true" }; return false }(),
                        "mtu": func() string { if _v, _ok := m["mtu"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "ipv4_mask_length": func() string { if _v, _ok := m["ipv4-mask-length"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "name": func() string { if _v, _ok := m["name"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
            ...
            d.Set("gre_interfaces", mapped)
        }
    } else {
        d.Set("gre_interfaces", []interface{}{})
    }
    ...
    d.SetId(fmt.Sprintf("show-interfaces-by-type-" + acctest.RandString(10)))
    return nil
}

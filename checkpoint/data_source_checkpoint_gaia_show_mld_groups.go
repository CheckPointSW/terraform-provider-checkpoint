...
func dataGaiaShowMldGroups() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowMldGroups,
        Schema: map[string]*schema.Schema{
            ...
            "order": {
                ...
                Optional:    true,
                Description: `Sorts the interface MLD groups entries by interface name in either ascending or descending order`,
            },
            "type": {
                Type:        schema.TypeString,
                Optional:    true,
                Description: `The type of the MLD group`,
            },
            "interface": {
                Type:        schema.TypeString,
                Optional:    true,
                Description: `The name of the interface associated with the MLD groups`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func readGaiaShowMldGroups(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "mld-groups",        // resource type
            "read",                       // operation
            "show-mld-groups",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-mld-groups: %v", err)
    }
            ...
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "age": func() string { if _v, _ok := m["age"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "expire": func() string { if _v, _ok := m["expire"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                    }
                }
            }
    ...
    d.SetId(fmt.Sprintf("show-mld-groups-" + acctest.RandString(10)))
    return nil
}

...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"checkpoint_management_import_outbound_inspection_certificate":         resourceManagementImportOutboundInspectionCertificate(),
			...
			"checkpoint_management_set_outbound_inspection_certificate":            resourceManagementSetOutboundInspectionCertificate(),

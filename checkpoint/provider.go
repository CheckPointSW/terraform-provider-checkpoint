...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"checkpoint_management_checkpoint_sase_data_center_server":             resourceManagementCheckpointSaseDataCenterServer(),
			"checkpoint_management_claroty_ctd_data_center_server":                 resourceManagementClarotyCtdDataCenterServer(),
			"checkpoint_management_servicenow_cmdb_data_center_server":             resourceManagementServicenowCmdbDataCenterServer(),
			"checkpoint_management_nozomi_data_center_server":                      resourceManagementNozomiDataCenterServer(),
			"checkpoint_management_guardicore_data_center_server":                  resourceManagementGuardicoreDataCenterServer(),
			...
			"checkpoint_management_dlp_next_data_type":                             resourceManagementDlpNextDataType(),
			"checkpoint_management_regulation":                                     resourceManagementRegulation(),
			"checkpoint_management_requirement":                                    resourceManagementRequirement(),
			"checkpoint_management_firewall_best_practice":                         resourceManagementFirewallBestPractice(),
			"checkpoint_management_guideline":                                      resourceManagementGuideline(),
			"checkpoint_management_guideline_cell_approvals":                       resourceManagementGuidelineCellApprovals(),
			"checkpoint_management_def_setting":                                    resourceManagementDefSetting(),
			"checkpoint_management_set_cloud_license_scope":                        resourceManagementSetCloudLicenseScope(),
			"checkpoint_management_scheduled_event":                                resourceManagementScheduledEvent(),
			"checkpoint_management_export_access_rulebase":                         resourceManagementExportAccessRulebase(),
			"checkpoint_management_test_ai_guard_api_key":                          resourceManagementTestAiGuardApiKey(),
			"checkpoint_management_set_threat_protection_category":                 resourceManagementSetThreatProtectionCategory(),
			"checkpoint_management_set_threat_protection_sub_category":             resourceManagementSetThreatProtectionSubCategory(),
			"checkpoint_management_set_threat_extraction_file_type":                resourceManagementSetThreatExtractionFileType(),
			"checkpoint_management_set_threat_extraction_file_types":               resourceManagementSetThreatExtractionFileTypes(),
			"checkpoint_management_set_threat_emulation_file_type":                 resourceManagementSetThreatEmulationFileType(),
			"checkpoint_management_set_threat_emulation_file_types":                resourceManagementSetThreatEmulationFileTypes(),
			"checkpoint_management_set_cloud_license_gateway":                      resourceManagementSetCloudLicenseGateway(),
			"checkpoint_management_set_cloud_license_pool":                         resourceManagementSetCloudLicensePool(),
			"checkpoint_management_update_cloud_license":                           resourceManagementUpdateCloudLicense(),
		},
		DataSourcesMap: map[string]*schema.Resource{
			...
			"checkpoint_management_checkpoint_sase_data_center_server":        dataSourceManagementCheckpointSaseDataCenterServer(),
			"checkpoint_management_claroty_ctd_data_center_server":            dataSourceManagementClarotyCtdDataCenterServer(),
			"checkpoint_management_servicenow_cmdb_data_center_server":        dataSourceManagementServicenowCmdbDataCenterServer(),
			"checkpoint_management_nozomi_data_center_server":                 dataSourceManagementNozomiDataCenterServer(),
			"checkpoint_management_guardicore_data_center_server":             dataSourceManagementGuardicoreDataCenterServer(),
			...
			"checkpoint_management_dlp_next_data_type":                        dataSourceManagementDlpNextDataType(),
			"checkpoint_management_def_setting":                               dataSourceManagementDefSetting(),
			"checkpoint_management_firewall_best_practice":                    dataSourceManagementFirewallBestPractice(),
			"checkpoint_management_guideline":                                 dataSourceManagementGuideline(),
			"checkpoint_management_regulation":                                dataSourceManagementRegulation(),
			"checkpoint_management_requirement":                               dataSourceManagementRequirement(),
			"checkpoint_management_scheduled_event":                           dataSourceManagementScheduledEvent(),
			"checkpoint_management_cloud_license_gateway":                     dataSourceManagementCloudLicenseGateway(),
			"checkpoint_management_cloud_license_scope":                       dataSourceManagementCloudLicenseScope(),
			"checkpoint_management_cloud_license_pool":                        dataSourceManagementCloudLicensePool(),
			"checkpoint_management_threat_emulation_file_type":                dataSourceManagementThreatEmulationFileType(),
			"checkpoint_management_threat_emulation_image":                    dataSourceManagementThreatEmulationImage(),
			"checkpoint_management_threat_extraction_file_type":               dataSourceManagementThreatExtractionFileType(),
			"checkpoint_management_threat_protection_category":                dataSourceManagementThreatProtectionCategory(),
			"checkpoint_management_threat_protection_sub_category":            dataSourceManagementThreatProtectionSubCategory(),
		},

...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"checkpoint_management_data_type_file_type_attributes":                 resourceManagementDataTypeFileAttributes(),
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"checkpoint_management_data_type_file_type_attributes":            dataSourceManagementDataTypeFileAttributes(),

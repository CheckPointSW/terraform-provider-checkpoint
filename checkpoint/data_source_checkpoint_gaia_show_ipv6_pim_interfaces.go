...
func dataGaiaShowIpv6PimInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIpv6PimInterfaces,
...
func readGaiaShowIpv6PimInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ipv6-pim-interfaces",        // resource type
            "read",                       // operation
            "show-ipv6-pim-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ipv6-pim-interfaces: %v", err)
    }
            ...
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "dr_priority": func() string { if _v, _ok := m["dr-priority"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "dr_address": func() string { if _v, _ok := m["dr-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "mode": func() string { if _v, _ok := m["mode"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "neighbor_amount": func() int { if f, ok := m["neighbor-amount"].(float64); ok { return int(f) }; return 0 }(),
    ...
    d.SetId(fmt.Sprintf("show-ipv6-pim-interfaces-" + acctest.RandString(10)))
    return nil
}

...
func dataGaiaShowBootpInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowBootpInterfaces,
        Schema: map[string]*schema.Schema{
            ...
            "order": {
                ...
                Optional:    true,
                Description: `Sorts the bootp interfaces in either ascending or descending order.`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func readGaiaShowBootpInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "bootp-interfaces",        // resource type
            "read",                       // operation
            "show-bootp-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-bootp-interfaces: %v", err)
    }
            ...
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "max_hopcount": func() int { if f, ok := m["max-hopcount"].(float64); ok { return int(f) }; return 0 }(),
                        "wait_time": func() int { if f, ok := m["wait-time"].(float64); ok { return int(f) }; return 0 }(),
                        "primary": func() string { if _v, _ok := m["primary"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "gateway_address": func() string { if _v, _ok := m["gateway-address"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "relay_to": func() []interface{} {
                            var _sgOut []interface{}
                            if _arr, _ok := m["relay-to"].([]interface{}); _ok {
                        ...
                        "option_82_enabled": func() bool { if b, ok := m["option-82-enabled"].(bool); ok { return b }; if s, ok := m["option-82-enabled"].(string); ok { return s == "true" }; return false }(),
                        "circuit_id": func() string { if _v, _ok := m["circuit-id"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "remote_id": func() string { if _v, _ok := m["remote-id"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
    ...
    d.SetId(fmt.Sprintf("show-bootp-interfaces-" + acctest.RandString(10)))
    return nil
}

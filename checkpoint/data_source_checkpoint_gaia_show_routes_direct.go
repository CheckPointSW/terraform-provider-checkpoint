...
func dataGaiaShowRoutesDirect() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowRoutesDirect,
...
func readGaiaShowRoutesDirect(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "routes-direct",        // resource type
            "read",                       // operation
            "show-routes-direct",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-routes-direct: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-routes-direct-" + acctest.RandString(10)))
    return nil
}

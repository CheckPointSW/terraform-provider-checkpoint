...
func dataGaiaShowIpv6PimNeighbor() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIpv6PimNeighbor,
...
func readGaiaShowIpv6PimNeighbor(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ipv6-pim-neighbor",        // resource type
            "read",                       // operation
            "show-ipv6-pim-neighbor",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ipv6-pim-neighbor: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-ipv6-pim-neighbor-" + acctest.RandString(10)))
    return nil
}

...
func dataGaiaShowVlanInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowVlanInterfaces,
...
func readGaiaShowVlanInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "vlan-interfaces",        // resource type
            "read",                       // operation
            "show-vlan-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-vlan-interfaces: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-vlan-interfaces-" + acctest.RandString(10)))
    return nil
}

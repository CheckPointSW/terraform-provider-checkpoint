...
func createManagementSmtpServer(d *schema.ResourceData, m interface{}) error {
	...
	addSmtpServerRes, err := client.ApiCall("add-smtp-server", smtpServer, client.GetSessionID(), true, false)
...
func readManagementSmtpServer(d *schema.ResourceData, m interface{}) error {
	...
	showSmtpServerRes, err := client.ApiCall("show-smtp-server", payload, client.GetSessionID(), true, false)
	if err != nil {
		return fmt.Errorf(err.Error())
	}
...
func updateManagementSmtpServer(d *schema.ResourceData, m interface{}) error {
	...
	updateSmtpServerRes, err := client.ApiCall("set-smtp-server", smtpServer, client.GetSessionID(), true, false)
...
func deleteManagementSmtpServer(d *schema.ResourceData, m interface{}) error {
	...
	deleteSmtpServerRes, err := client.ApiCall("delete-smtp-server", smtpServerPayload, client.GetSessionID(), true, false)

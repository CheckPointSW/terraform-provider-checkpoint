...
func dataGaiaShowPimVirtualInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowPimVirtualInterfaces,
...
func readGaiaShowPimVirtualInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "pim-virtual-interfaces",        // resource type
            "read",                       // operation
            "show-pim-virtual-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-pim-virtual-interfaces: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-pim-virtual-interfaces-" + acctest.RandString(10)))
    return nil
}

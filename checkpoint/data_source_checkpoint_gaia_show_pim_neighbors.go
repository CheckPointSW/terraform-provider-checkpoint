...
func dataGaiaShowPimNeighbors() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowPimNeighbors,
...
func readGaiaShowPimNeighbors(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "pim-neighbors",        // resource type
            "read",                       // operation
            "show-pim-neighbors",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-pim-neighbors: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-pim-neighbors-" + acctest.RandString(10)))
    return nil
}

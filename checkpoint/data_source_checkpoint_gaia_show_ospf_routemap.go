...
func dataGaiaShowOspfRoutemap() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowOspfRoutemap,
...
func readGaiaShowOspfRoutemap(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ospf-routemap",        // resource type
            "read",                       // operation
            "show-ospf-routemap",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ospf-routemap: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-ospf-routemap-" + acctest.RandString(10)))
    return nil
}

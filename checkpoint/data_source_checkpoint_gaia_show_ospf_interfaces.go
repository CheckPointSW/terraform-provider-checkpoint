...
func dataGaiaShowOspfInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowOspfInterfaces,
...
func readGaiaShowOspfInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "ospf-interfaces",        // resource type
            "read",                       // operation
            "show-ospf-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-ospf-interfaces: %v", err)
    }
            ...
            for i, item := range raw {
                if m, ok := item.(map[string]interface{}); ok {
                    mapped[i] = map[string]interface{}{
                        ...
                        "bdr": func() string { if _v, _ok := m["bdr"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "dr": func() string { if _v, _ok := m["dr"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "errors": func() int { if f, ok := m["errors"].(float64); ok { return int(f) }; return 0 }(),
                        "name": func() string { if _v, _ok := m["name"]; _ok && _v != nil { return fmt.Sprintf("%v", _v) }; return "" }(),
                        "neighbor_count": func() int { if f, ok := m["neighbor-count"].(float64); ok { return int(f) }; return 0 }(),
    ...
    d.SetId(fmt.Sprintf("show-ospf-interfaces-" + acctest.RandString(10)))
    return nil
}

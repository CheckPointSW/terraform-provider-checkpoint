...
func createManagementNetworkFeed(d *schema.ResourceData, m interface{}) error {
	...
	addNetworkFeedRes, err := client.ApiCall("add-network-feed", networkFeed, client.GetSessionID(), true, false)
...
func updateManagementNetworkFeed(d *schema.ResourceData, m interface{}) error {
	...
	updateNetworkFeedRes, err := client.ApiCall("set-network-feed", networkFeed, client.GetSessionID(), true, false)
...
func deleteManagementNetworkFeed(d *schema.ResourceData, m interface{}) error {
	...
	deleteNetworkFeedRes, err := client.ApiCall("delete-network-feed", networkFeedPayload, client.GetSessionID(), true, false)

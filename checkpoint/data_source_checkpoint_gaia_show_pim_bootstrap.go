...
func dataGaiaShowPimBootstrap() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowPimBootstrap,
...
func readGaiaShowPimBootstrap(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "pim-bootstrap",        // resource type
            "read",                       // operation
            "show-pim-bootstrap",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-pim-bootstrap: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-pim-bootstrap-" + acctest.RandString(10)))
    return nil
}

...
func createManagementInteroperableDevice(d *schema.ResourceData, m interface{}) error {
	...
	addInteroperableDeviceRes, err := client.ApiCall("add-interoperable-device", interoperableDevice, client.GetSessionID(), true, false)
...
func readManagementInteroperableDevice(d *schema.ResourceData, m interface{}) error {
	...
	showInteroperableDeviceRes, err := client.ApiCall("show-interoperable-device", payload, client.GetSessionID(), true, false)
	if err != nil {
		return fmt.Errorf(err.Error())
	}
...
func updateManagementInteroperableDevice(d *schema.ResourceData, m interface{}) error {
	...
	updateInteroperableDeviceRes, err := client.ApiCall("set-interoperable-device", interoperableDevice, client.GetSessionID(), true, false)
...
func deleteManagementInteroperableDevice(d *schema.ResourceData, m interface{}) error {
	...
	deleteInteroperableDeviceRes, err := client.ApiCall("delete-interoperable-device", interoperableDevicePayload, client.GetSessionID(), true, false)

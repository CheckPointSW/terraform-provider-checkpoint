...
func dataGaiaShowPbrTables() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowPbrTables,
        Schema: map[string]*schema.Schema{
            ...
            "order": {
                ...
                Optional:    true,
                Description: `Sorts the tables names in either ascending or descending order.`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func readGaiaShowPbrTables(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "pbr-tables",        // resource type
            "read",                       // operation
            "show-pbr-tables",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-pbr-tables: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-pbr-tables-" + acctest.RandString(10)))
    return nil
}

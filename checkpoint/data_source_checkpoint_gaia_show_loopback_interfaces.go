...
func dataGaiaShowLoopbackInterfaces() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowLoopbackInterfaces,
...
func readGaiaShowLoopbackInterfaces(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "loopback-interfaces",        // resource type
            "read",                       // operation
            "show-loopback-interfaces",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-loopback-interfaces: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-loopback-interfaces-" + acctest.RandString(10)))
    return nil
}

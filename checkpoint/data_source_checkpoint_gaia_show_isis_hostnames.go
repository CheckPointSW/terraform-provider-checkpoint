...
func dataGaiaShowIsisHostnames() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowIsisHostnames,
        Schema: map[string]*schema.Schema{
            ...
            "order": {
                Type:        schema.TypeString,
                Optional:    true,
                Description: `Sorts the database entries by their LSP IDs in either ascending or descending order.`,
            },
            "member_id": {
                Type:        schema.TypeString,
                Optional:    true,
...
func readGaiaShowIsisHostnames(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "isis-hostnames",        // resource type
            "read",                       // operation
            "show-isis-hostnames",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-isis-hostnames: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-isis-hostnames-" + acctest.RandString(10)))
    return nil
}

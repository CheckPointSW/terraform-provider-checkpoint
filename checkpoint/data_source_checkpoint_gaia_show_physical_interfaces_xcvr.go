...
func dataGaiaShowPhysicalInterfacesXcvr() *schema.Resource {   
    return &schema.Resource{
        Read:   readGaiaShowPhysicalInterfacesXcvr,
...
func readGaiaShowPhysicalInterfacesXcvr(d *schema.ResourceData, m interface{}) error {
    ...
    if resourceDebugEnabled(d) {
        ...
        debugLogOperation(
            "physical-interfaces-xcvr",        // resource type
            "read",                       // operation
            "show-physical-interfaces-xcvr",         // API call name
    ...
    if err != nil {
        return fmt.Errorf("Failed to execute show-physical-interfaces-xcvr: %v", err)
    }
    ...
    d.SetId(fmt.Sprintf("show-physical-interfaces-xcvr-" + acctest.RandString(10)))
    return nil
}

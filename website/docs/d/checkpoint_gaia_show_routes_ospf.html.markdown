---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_routes_ospf"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-routes-ospf"
description: |-
This resource allows you to execute Check Point Show Routes Ospf.
---

# checkpoint_gaia_show_routes_ospf
...
```hcl
data "checkpoint_gaia_show_routes_ospf" "example" {
  limit = 1
  offset = 0
  order = "DESC"
}

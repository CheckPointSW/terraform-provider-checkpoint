---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_routes_kernel"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-routes-kernel"
description: |-
This resource allows you to execute Check Point Show Routes Kernel.
---

# checkpoint_gaia_show_routes_kernel
...
```hcl
data "checkpoint_gaia_show_routes_kernel" "example" {
  limit = 1
  offset = 0
  order = "DESC"
}

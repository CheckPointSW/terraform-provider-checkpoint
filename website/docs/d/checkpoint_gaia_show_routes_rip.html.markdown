---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_routes_rip"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-routes-rip"
description: |-
This resource allows you to execute Check Point Show Routes Rip.
---

# checkpoint_gaia_show_routes_rip
...
```hcl
data "checkpoint_gaia_show_routes_rip" "example" {
  limit = 1
  offset = 0
  order = "DESC"
}

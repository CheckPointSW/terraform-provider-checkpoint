---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_configuration_bgp_confederation_peers"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-configuration-bgp-confederation-peers"
description: |-
This resource allows you to execute Check Point Show Configuration Bgp Confederation Peers.
---

# checkpoint_gaia_show_configuration_bgp_confederation_peers
...
```hcl
data "checkpoint_gaia_show_configuration_bgp_confederation_peers" "example" {
}
```

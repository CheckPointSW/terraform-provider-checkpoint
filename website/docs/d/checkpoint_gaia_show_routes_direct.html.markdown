---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_routes_direct"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-routes-direct"
description: |-
This resource allows you to execute Check Point Show Routes Direct.
---

# checkpoint_gaia_show_routes_direct
...
```hcl
data "checkpoint_gaia_show_routes_direct" "example" {
  limit = 1
  offset = 0
  order = "DESC"
}

---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_routes_bgp"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-routes-bgp"
description: |-
This resource allows you to execute Check Point Show Routes Bgp.
---

# checkpoint_gaia_show_routes_bgp
...
```hcl
data "checkpoint_gaia_show_routes_bgp" "example" {
  limit = 1
  offset = 0
  order = "DESC"
}

---
layout: "checkpoint"
page_title: "checkpoint_gaia_show_ipv6_pim_joins"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-show-ipv6-pim-joins"
description: |-
This resource allows you to execute Check Point Show Ipv6 Pim Joins.
---

# checkpoint_gaia_show_ipv6_pim_joins
...
```hcl
data "checkpoint_gaia_show_ipv6_pim_joins" "example" {
}
```

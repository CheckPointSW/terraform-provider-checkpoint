...
sidebar_current: "docs-checkpoint-resource-checkpoint-management-nozomi-data-center-server"
description: |- This resource allows you to execute Check Point Nozomi data center server.
---

# Resource: checkpoint_management_nozomi_data_center_server
...
* `hostname` - (Required) IP address or hostname of the Nozomi Guardian or CMC server.
* `key_name` - (Required) API key name for Nozomi.
* `key_token` - (Required) API key token for Nozomi.

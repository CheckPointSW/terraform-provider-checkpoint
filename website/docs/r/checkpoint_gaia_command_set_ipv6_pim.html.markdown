---
layout: "checkpoint"
page_title: "checkpoint_gaia_command_set_ipv6_pim"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-command-set-ipv6-pim"
description: |-
This resource allows you to execute Check Point Set Ipv6 Pim.
---

# checkpoint_gaia_command_set_ipv6_pim
...
```hcl
resource "checkpoint_gaia_command_set_ipv6_pim" "example" {
  mode              = "sparse"
  data_interval     = "23"
  assert_interval   = "24"
  hello_interval    = "26"

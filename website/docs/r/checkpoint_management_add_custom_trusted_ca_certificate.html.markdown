...
sidebar_current: "docs-checkpoint-resource-checkpoint-management-add-custom-trusted-ca-certificate"
description: |-
This resource allows you to execute Check Point Add Custom Trusted Ca Certificate.
---
...
* `base64_certificate` - (Required) Certificate file encoded in base64.<br/>Valid file formats: x509. 
* `name` - Object name.

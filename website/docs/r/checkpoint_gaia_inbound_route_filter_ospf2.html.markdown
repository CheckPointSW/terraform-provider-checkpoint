---
layout: "checkpoint"
page_title: "checkpoint_gaia_inbound_route_filter_ospf2"
sidebar_current: "docs-checkpoint-resource-checkpoint-gaia-inbound-route-filter-ospf2"
description: |-
This resource allows you to execute Check Point Inbound Route Filter Ospf2.
---

# checkpoint_gaia_inbound_route_filter_ospf2
...
```hcl
resource "checkpoint_gaia_inbound_route_filter_ospf2" "example" {
  instance = "default"
...
* `instance` - (Optional) Configures filtering of IPv4 routes for a specific OSPFv2 instance.  Note: The specified OSPFv2 instance must be configured 
...
* `reset` - (Optional) Resets Inbound Route Filter configuration to a default state for a given OSPFv2 instance 
